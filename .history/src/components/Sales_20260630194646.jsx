            ...
            <div className="container">
              ...
              <div className="faq__wrapper">
               ...
               <div className="accordion__card">
                ...
                <div className="collapse show">
                 <div className="accordion__body">
                   trial period expires. With Premium access, you can learn at your own pace and as frequently as you desire, and you may terminate your subscription prior to the conclusion of the 7-day free trial.
                 </div>
                </div>
               </div>
               <div className="accordion__card">
