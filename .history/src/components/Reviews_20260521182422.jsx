          ...
          <div className="reviews__wrapper">
            <div className="review">
              ...
              <div className="review__header">
                ...
                <p className="review__body">
                  This app is a great way to get the main takeaways from a book without having to read the entire thing. <b>game-changer</b> for me! It's saved me so much time and effort in reading and comprehending books. Highly recommend it to all book lovers
                </p>
              </div>
              <div className="review">
              <div className="review__header">
