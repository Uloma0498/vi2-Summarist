          ...
          <div className="reviews__wrapper">
            <div className="review">
              ...
              <div className="review__header">
                ...
                <p className="review__body">
                  If you're a busy  <b>loves reading but doesn't have the time</b> to read every book in full, this app is for you! The summaries are thorough and provide a great overview of the book's content.
                </p>
              </div>
            </div>
          </div>
