...
const SidebarDesktop = () => {
    const  [isLoggedIn, setLoggedIn] = useStat(true);
        ...
        <div className="sidebar-desktop">
            ...
            <div className="sidebar__wrapper">
                ...
                <div className="sidebar__bottom">
                    ...
                    <div className="sidebar__link--wrapper" onClick={isLoggedIn ? handleLogout : handleLogin}>
                        <div className="sidebar__link--line"></div>
                        <div className="sidebar__icon--wrapper">
                            <FontAwesomeIcon icon="arrowrightfrombracket" />
                        </div>
                        <div className="sidebar__link--text">{isLoggedIn ? 'Logout' : 'Login'}</div>
                    </div>
                </div>
            </div>
        </div>
