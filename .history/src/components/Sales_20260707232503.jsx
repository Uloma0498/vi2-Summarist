            ...
            <div className="container">
              ...
              <div className="plan__card--cta">
                ...
                <div className="plan__disclaimer">
                 {selectedPlan === "premiumPlus" ? "Cancel your trial at any time before it ends, and you won’t be charged." : selectedPlan === "premiumMonthly" ? "No trial included. You can cancel anytime." : ""}
                </div>
              </div>
