      ...
      <div className="wrapper">
        ...
        <div className="row">
         ...
         <div>(Premium)</div>)}
          ...
          <div className="inner-bookimage-wrapper">
            <figure className="book__image--wrapper" height={300} width={300} minWidth={300}>
             <img src={bookDetails.imageLink} alt="Book Cover" />
            </figure>
          </div>
        </div>
            ) : (
