...
const BookDetails = () => {
  ...
  useInsertionEffect(() => {
    const fetchBookDetails = async () => {
      try {
        const response = await axios.get ('https://us-central1-summaristt.cloudfunctions.net/getBook?id=$%7Bid%7D');
        setBookDetails(respos)
      }
    }
  })
        ...
        <div className="row">
          <div className="container">
            ...
            <div className="inner-book__author--description">
             kdhs;;;;;;;;;;;;;;dlkgjdhdhhdhhdhdhdhdhdhdakjajaakakksjsj
            </div>
          </div>
