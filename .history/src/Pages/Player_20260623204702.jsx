...
const Player = () => {
      ...
      const readSummary = () => {
        if (player && player.summary){
          const utterance = new SpeechSynthesisUtterance(player.summary);
          ...
          <div className="wrapper">
            ...
            <div className="summary">
              ...
              <div className="audio__wrapper">
                  <audio ref={audioRef} src={player.audioLink} type="audio/mpeg" />
                ...
                <div className="audio__controls--wrapper">
                  ...
                  <button className="audio__controls--btn audio__controls--btn--play" onClick={ ()handlePlayPause(); readSummary(); }>
