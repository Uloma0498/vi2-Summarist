              ...
              <div className="audio__wrapper">
                ...
                <div className="audio__track--wrapper">
                 <figure className="audio__track--image-mask">
                  ...
                  <img className="book__image" src={bookDetails.imageUrl} alt={bookDetails.title} />
                  </figure>
                 </figure>
                ...
                <div className="audio__controls--wrapper">
                  ...
                  <button className="audio__control--button">Play</button>
                  <button className="audio__control--button">Pause</button>
                </div>
              </div>
            </div>
            </div>
